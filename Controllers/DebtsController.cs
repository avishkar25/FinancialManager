...
namespace FinancialManager.Controllers
{
    public class DebtsController : Controller
    {
        ...
        public DebtsController(FinancialManagerContext context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Create([Bind("Id,Creditor,Amount,DueDate")] Debt debt)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,Creditor,Amount,DueDate")] Debt debt)
        {
            if (id != debt.Id)
            {
                return NotFound();
